  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-green-600 py-12 text-center">
        <h1 className="text-3xl font-bold text-white">甲州織</h1>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-4">
        <nav className="text-sm text-gray-600">
          ...
          <span className="text-gray-900">甲州織</span>
        </nav>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 pb-16">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            <div className="lg:w-1/2">
              <h3 className="text-2xl font-bold mb-4">
                <span className="text-green-600">美しい深みのある色と光沢</span>
              </h3>
              <div className="text-gray-700 leading-relaxed mb-6">
                <p>
                  甲州織の美しさは先染めにあります。<br />
                  糸を先に染めるため深みのある色と光沢があり<br />
                  清楚で高級感が漂います。
                </p>
              </div>
              <a 
        ...
        <section className="mt-16">
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            <div className="lg:w-1/2">
              <h3 className="text-2xl font-bold mb-4">
                <span className="text-green-600">一生もののアイテム</span>
              </h3>
              <div className="text-gray-700 leading-relaxed mb-6">
                <p>
                  昔から傘に扱われてきた甲州織。<br />
                  日本の傘としての地位を築き上げてきました。<br />
                  大切な方への贈り物としてお祝いにも最適です。<br />
                  雨の日のこだわりの一生もののアイテムです。<br />
                  修理ができるので末永くお使い頂けます。
                </p>
              </div>
              <a 
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <img 
                src="https://maruyasuweb.jp/wp-content/themes/maruyasuweb/img/kosyu/img04.jpg" 
                alt="甲州織ボーダー" 
            ...
            <div className="text-center">
              <img 
                src="https://maruyasuweb.jp/wp-content/themes/maruyasuweb/img/kosyu/img05.jpg" 
                alt="甲州織両面裏格子" 
                className="w-full mb-2 rounded"
              />
            ...
            <div className="text-center">
              <img 
                src="https://maruyasuweb.jp/wp-content/themes/maruyasuweb/img/kosyu/img06.jpg" 
                alt="甲州織両面無地" 
                className="w-full mb-2 rounded"
              />
            ...
            <div className="text-center">
              <img 
                src="https://maruyasuweb.jp/wp-content/themes/maruyasuweb/img/kosyu/img07.jpg" 
                alt="甲州織ブロケード" 
                className="w-full mb-2 rounded"
              />
