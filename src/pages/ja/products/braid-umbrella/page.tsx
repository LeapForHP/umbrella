  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-green-600 py-12 text-center">
        <h1 className="text-3xl font-bold text-white">雅桜組ひも長傘</h1>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-4">
        <nav className="text-sm text-gray-600">
          ...
          <span className="text-gray-900">雅桜組ひも長傘</span>
        </nav>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 pb-16">
        ...
        <div className="text-center py-8">
          <p className="text-xl text-gray-700">和の美意識が感じられる日本の傘と言える傘を!</p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            <div className="lg:w-1/2">
              <h3 className="text-2xl font-bold mb-4">
                <span className="text-green-600">日本の伝統工芸の組ひも</span>
              </h3>
              <div className="text-gray-700 leading-relaxed">
                <p>
                  雅桜はそのコンセプトから作られました。<br />
                  山桜、甲州織、日本を感じられる素材を使い職人が1本1本手作りしています。<br />
                  甲州織の生地は、糸を染色してから織るため、<br />
                  タテ糸とヨコ糸が織りなす上品で重厚な手触りと風合い、独特の光沢があります。
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mt-16">
          <div className="flex flex-col lg:flex-row-reverse items-start gap-8">
            ...
            <div className="lg:w-1/2">
              <h3 className="text-2xl font-bold mb-4">
                <span className="text-green-600">組ひもと傘の融合</span>
              </h3>
              <div className="text-gray-700 leading-relaxed">
                <p>
                  着物の帯締めから着想を得て組ひもを<br />
                  奈良吉野の希少な山桜を削り出して仕上げた持ち手に丁寧に巻き施しています。<br />
                  雅桜の握り感は、今までにない感触で心地いい手触りです。傘を差した時に持ち手が滑りません。<br />
                  甲州織と組ひも、独特の風合いが、メイドインジャパンの傘と言える一品に仕上がりました。
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center py-16">
          <p className="text-xl text-gray-700">10本の紐を平織で手編みした組ひもを山桜の持ち手に丁寧に巻き施しています。</p>
        </div>
        ...
        <section className="mt-8">
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            <div className="lg:w-1/2">
              <h3 className="text-2xl font-bold mb-4">
                <span className="text-green-600">末広がりの縁起物</span>
              </h3>
              <div className="text-gray-700 leading-relaxed">
                <p>
                  傘は昔から末広がりの縁起物として扱われ、結納の贈り物や引き出物としても使われてきました。<br />
                  大切な方への贈り物としても最適です。不具合が発生しても依頼を頂ければすぐに修理ができるので末永くお使いいただけます。
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mt-16">
          ...
          <p className="text-center text-green-600 text-xl font-bold mb-8">MOVIE</p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center text-gray-700">
              <p>*おもてなしセレクション受賞いたしました。</p>
              <p>*組ひも持ち手の実用新案取得いたしました。</p>
            </div>
          </div>
        </section>
